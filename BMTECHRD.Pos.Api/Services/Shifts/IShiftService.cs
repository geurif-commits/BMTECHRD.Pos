...
public interface IShiftService
{
    ...
    Task<CreateShiftResponse> OpenAsync(CreateShiftRequest req, CancellationToken ct);
    Task<ShiftSummaryDto> CloseAsync(CloseShiftRequest req, CancellationToken ct);
